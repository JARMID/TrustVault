...
const categoryData = [
  { name: 'UI Rendering', count: 23, color: 'var(--brand-primary)' },
  { name: 'API Timeout', count: 18, color: 'var(--accent-danger)' },
  { name: 'Auth Failure', count: 14, color: 'var(--brand-primary)' },
  { name: 'Data Sync', count: 9, color: 'var(--brand-primary)' },
  { name: 'Network', count: 7, color: '#06B6D4' },
  { name: 'Other', count: 4, color: 'var(--text-tertiary)' },
];
...
const TERMINAL_LOGS = [
  ...
  "[ERR] WebSocket connection dropped â€” reconnecting in 3s...",
  "[WARN] Memory usage at 87% â€” garbage collection triggered",
];
  ...
  return (
    <motion.div variants={containerVariants} initial="hidden" animate="show" style={{ maxWidth: 1440, margin: '0 auto' }}>
        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <div className="flex items-center gap-2 px-3 py-1 rounded-full" style={{ background: 'rgba(239, 68, 68,0.1)', border: '1px solid rgba(239, 68, 68,0.2)' }}>
              ...
              <span style={{ fontSize: '0.7rem', fontWeight: 600, color: 'var(--accent-danger)', letterSpacing: '0.05em' }}>3 OPEN</span>
            </div>
          </div>
      ...
      <div className="grid grid-cols-4 gap-6 mb-8">
        {[
          { label: 'Open Bugs', value: '23', trend: '-12%', icon: <Bug size={20} />, color: 'var(--accent-danger)' },
