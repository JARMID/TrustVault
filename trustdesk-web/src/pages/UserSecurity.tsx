    ...
    <div style={{ position: 'relative' }}>
      ...
      <motion.div variants={cV} initial="hidden" animate="show" style={{ maxWidth: '1200px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
        ...
        <div className="grid gap-6" style={{ gridTemplateColumns: '200px 1fr 320px', marginBottom: '24px' }}>
          ...
          {/* Security Score */}
          <motion.div variants={iV} className="liquid-glass-card mesh-bg" style={{ padding: '24px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ position: 'relative', width: '100px', height: '100px', marginBottom: '12px' }}>
              <svg width="100" height="100" viewBox="0 0 100 100">
                ...
                <circle cx="50" cy="50" r="42" fill="none" stroke="var(--brand-primary)" strokeWidth="8" strokeLinecap="round" strokeDasharray={`${2 * Math.PI * 42 * securityScore / 100} ${2 * Math.PI * 42}`} transform="rotate(-90 50 50)" style={{ filter: 'drop-shadow(0 0 6px rgba(0, 198, 174,0.4))' }} />
              </svg>
          ...
          <motion.div variants={iV} style={{
            ...
            border: `2px solid ${isWalletFrozen ? 'rgba(239, 68, 68,0.3)' : 'var(--border-subtle)'}`,
