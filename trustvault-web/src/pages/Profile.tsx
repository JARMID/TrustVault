...
const PRESET_AVATARS = [
  ...
  'https://api.dicebear.com/7.x/notionists/svg?seed=Lily&backgroundColor=c0aede',
  'https://api.dicebear.com/7.x/fun-emoji/svg?seed=Jack&backgroundColor=ffdfbf',
  'https://api.dicebear.com/7.x/fun-emoji/svg?seed=Jocelyn&backgroundColor=b6e3f4',
  'https://api.dicebear.com/7.x/bottts/svg?seed=Caleb&backgroundColor=d1d4f9',
  'https://api.dicebear.com/7.x/bottts/svg?seed=Aneka&backgroundColor=c0aede',
  'https://api.dicebear.com/7.x/adventurer/svg?seed=Destiny&backgroundColor=ffdfbf',
  'https://api.dicebear.com/7.x/adventurer/svg?seed=Leo&backgroundColor=b6e3f4',
  'https://api.dicebear.com/7.x/shapes/svg?seed=Bandit&backgroundColor=d1d4f9',
];
...
const Profile: React.FC = () => {
  ...
  const mergedProfile = {
    ...DEFAULT_PROFILE,
    name: authProfile?.full_name || DEFAULT_PROFILE.name,
    email: authProfile?.email || DEFAULT_PROFILE.email,
    role: authProfile?.role || DEFAULT_PROFILE.role,
    avatarUrl: authProfile?.avatar_url || DEFAULT_PROFILE.avatarUrl,
  };

  const [profile, setProfile] = useState<ProfileData>(mergedProfile);
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        {editing && (
          ...
          >
            ...
            <h4 style={{ fontSize: '0.75rem', fontWeight: 600, color: 'var(--text-tertiary)', marginBottom: '12px' }}>Fun & Expressive</h4>
            <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px' }}>
              {PRESET_AVATARS.map((url, idx) => {
                const isSelected = editData.avatarUrl === url;
                return (
                  <motion.button
                    key={idx}
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.9 }}
                    onClick={() => setEditData({ ...editData, avatarUrl: url })}
                    style={{
            ...
            <h4 style={{ fontSize: '0.75rem', fontWeight: 600, color: 'var(--text-tertiary)', marginBottom: '12px' }}>Signature Gradients</h4>
