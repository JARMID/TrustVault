    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          Positioned.fill(child: CustomPaint(painter: _EmergencyGridPainter())),
                    ...
                    child: GlassContainer(
                      ...
                      child: Column(
                        children: [
                          ...
                          _buildProtocolItem(
                            'Freeze all connected wallets',
                            Icons.account_balance_wallet_outlined,
                          ),
                          const SizedBox(height: 6),
                          _buildProtocolItem(
                            'Broadcast GPS to trusted contacts',
                            Icons.location_on_outlined,
                          ),
                          const SizedBox(height: 6),
                          _buildProtocolItem(
                            'Lock all active sessions remotely',
                            Icons.lock_outline,
                          ),
                          const SizedBox(height: 6),
                          _buildProtocolItem(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: AppTheme.danger.withAlpha(
                        (20 * (1 - _pulseController.value)).toInt(),
                      ),
                      width: 1,
                    ),
                  ),
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: AppTheme.danger.withAlpha(
                          _isHolding
                              ? 60
                              : (15 + (15 * _pulseController.value).toInt()),
                        ),
          ...
          SizedBox(
            ...
            child: OutlinedButton(
              ...
              style: OutlinedButton.styleFrom(
                side: BorderSide(color: AppTheme.danger.withAlpha(60)),
